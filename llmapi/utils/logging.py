...
BASELOGFMT = f"[time] %(asctime)s.%(msecs)03d{SEP}[level] %(levelname)-6s [logger] %(name)-10s{SEP}[message] %(message)s"
DATEFMT = "%Y-%m-%d %H:%M:%S"
...
logger = logging.getLogger("llmapi.app")
